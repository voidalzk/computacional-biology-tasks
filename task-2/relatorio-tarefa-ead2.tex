...
\begin{center}
Nó 819 (225922), Nó 844 (148269), Nó 98 (122960), Nó 147 (104508), Nó 595 (83235)
\end{center}
...
\subsection{Comparativo dos hubs por grau e intermediação}

\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth]{top_hubs_grau_intermediacao_200ppi.png}
\caption{Top 10 nós por Grau (esquerda) e por Intermediação/Betweenness (direita). A comparação visual deixa clara a diferença entre os dois rankings.}
\end{figure}
